...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SpringBootJpaHazelcastCacheSampleApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SpringBootJpaHazelcastCacheSampleApplication");
     ...
     //   }
        ...
        config.getMapConfigs().put("com.springbootsample.jpa.cache.hazelcast.domain.*", initializeDomainMapConfig(jHipsterProperties));
